...
public class AddProjectPageSelenide {
    ...
    public SelenideElement getNameField() {return $(nameProjectSelector);}
    public SelenideElement getCodeField() {return $(codeProjectSelector);}
    public SelenideElement getDescriptionField() {return $(descriptionProjectSelector);}
