...
public class AddProjectSelenide {
    ...
    public void addProject(ProjectBuilder addProject) throws InterruptedException {
        sleep(500);
        getNameField().val(addProject.getName());
        getCodeField().val(addProject.getCode());
        getDescriptionField().val(addProject.getDescription());
        getAddProjectButton().submit();
    }
}
